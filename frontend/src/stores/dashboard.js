...
export const useDashboardStore = defineStore('dashboard', () => {
  ...
  function _applyLoadResponse(data) {
    ...
    optDate.value = data.opt_date || ''
    paramColumns.value = data.param_columns || []
    gridSummary.value = data.grid_summary || {}
  ...
  return {
    files, rawRows, asset, timeframe, optDate, paramColumns, gridSummary, filters,
