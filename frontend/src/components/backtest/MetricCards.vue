...
const metricList = computed(() => {
  ...
  return [
    ...
    },
    {
      ...
      colorClass: (m.total_return ?? 0) >= 0 ? 'text-accent-yellow' : 'text-accent-red-light',
    },
    {
      key: 'max_dd',
      label: 'Max DD',
    ...
    },
    {
      ...
      colorClass: (m.win_rate ?? 0) >= 50 ? 'text-accent-yellow' : 'text-accent-red-light',
    },
    {
      key: 'profit_factor',
      label: 'Profit F.',
      ...
      colorClass: m.profit_factor == null ? 'text-gray-400' : m.profit_factor >= 1.5 ? 'text-accent-yellow' : m.profit_factor >= 1 ? 'text-accent-brass' : 'text-accent-red-light',
    },
    {
      key: 'sharpe',
      label: 'Sharpe',
      ...
      colorClass: (m.sharpe ?? 0) >= 1.5 ? 'text-accent-yellow' : (m.sharpe ?? 0) >= 1 ? 'text-accent-brass' : 'text-gray-400',
    },
    {
      key: 'sortino',
      label: 'Sortino',
      ...
      colorClass: (m.sortino ?? 0) >= 1 ? 'text-accent-yellow' : 'text-gray-400',
    },
    {
      key: 'calmar',
      label: 'Calmar',
      ...
      colorClass: (m.calmar ?? 0) >= 3 ? 'text-accent-yellow' : (m.calmar ?? 0) >= 1 ? 'text-accent-brass' : 'text-gray-400',
    },
    {
      key: 'omega',
      label: 'Omega',
      ...
      colorClass: m.omega == null ? 'text-gray-400' : m.omega >= 1.5 ? 'text-accent-yellow' : m.omega >= 1 ? 'text-accent-brass' : 'text-accent-red-light',
    },
    {
      key: 'sterling',
      label: 'Sterling',
      ...
      colorClass: (m.sterling ?? 0) >= 3 ? 'text-accent-yellow' : (m.sterling ?? 0) >= 1 ? 'text-accent-brass' : 'text-gray-400',
    },
    {
      key: 'burke',
      label: 'Burke',
      ...
      colorClass: (m.burke ?? 0) >= 1 ? 'text-accent-yellow' : 'text-gray-400',
    },
  ]
})
